...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 25, 2018 at 10:55 AM
...
(1, 'E31160170', 'diterima', 'sangat memuaskan', 33),
(2, 'E31160306', 'diterima', 'abc', 44);
...
(41, 'E31160419', 'Pemanfaatan AR dev', '197008311998031001', 'abc', '197008311998031001', 'kelompok'),
(42, 'E31160419', 'Pemanfaatan AR rev', '197008311998031001', 'abc', '197008311998031001', 'kelompok'),
(43, 'E31160419', 'Rute terdekat menuju alun-alun', '197008311998031001', 'abc', '197008311998031001', 'kelompok'),
(44, 'E31160306', 'Sistem Informasi Jurusan Teknologi Informasi', '-', 'abc', '198807022016101001', 'kelompok');
...
('E31160306', 'E31160306', 'Faiqotul Hikmah', 'MIF', 'A'),
...
('E31160306', '0da601f6baec5618d19459a1d2bbf79b', 'mahasiswa'),
...
ALTER TABLE `tb_hasil`
  ADD CONSTRAINT `tb_hasil_ibfk_2` FOREIGN KEY (`id_judul_usulan`) REFERENCES `tb_judul_usulan` (`id_judul_usulan`) ON DELETE CASCADE ON UPDATE CASCADE,
